...
pacman -S --noconfirm xorg-server xorg-xinit nano xorg-xkill xorg-xsetroot xorg-xbacklight xorg-xprop \
     ...
     dhcpcd networkmanager wpa_supplicant wireless_tools netctl dialog rsync pamixer
...
mkdir -p ~/Downloads ~/Documents ~/Music ~/Pictures ~/Public ~/Templates ~/code
